import { Scene, Mesh, Vector3, SceneLoader, TransformNode, PBRMetallicRoughnessMaterial, ExecuteCodeAction, ActionManager, Texture, Color3, AnimationGroup, ParticleSystem, Color4, VertexBuffer } from "@babylonjs/core";
...
export class Environment {
    ...
    public async load() {
        ...
        //--LANTERNS--
        assets.lantern.isVisible = true; //original mesh is not visible
    ...
    public async _loadAsset() {
        ...
        const result = await SceneLoader.ImportMeshAsync(null, "./models/", "scene.glb", this._scene);
